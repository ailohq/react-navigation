...
export default function TabRouter(_ref = {}) {
  let {
    backBehavior = 'history'
      ...
      options = _objectWithoutProperties(_ref, ["backBehavior"]);
  ...
  const router = _objectSpread(_objectSpread({}, BaseRouter), {}, {
    ...
    getStateForRouteNamesChange(state, {
      ...
      const index = routeNames.includes(currentRouteName) ? routeNames.indexOf(currentRouteName) : initialRouteName && routeNames.includes(initialRouteName) ? routeNames.indexOf(initialRouteName) : 0;
