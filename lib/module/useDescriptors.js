...
export default function useDescriptors({
  ...
  return state.routes.reduce((acc, route) => {
    ...
    const routeOptions = _objectSpread(_objectSpread(_objectSpread({}, typeof screenOptions === 'object' || screenOptions == null ? screenOptions : // @ts-ignore: this is a function, but typescript doesn't think so
    screenOptions({
      // @ts-ignore
      route,
      navigation
    })), typeof screen.options === 'object' || screen.options == null ? screen.options : // @ts-ignore: this is a function, but typescript doesn't think so
    screen.options({
      // @ts-ignore
      route,
      // @ts-ignore
